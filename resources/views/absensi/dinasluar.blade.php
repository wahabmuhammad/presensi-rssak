...
@section('header')
    ...
    <div class="appHeader bg-success text-light">
        ...
        <div class="pageTitle">Presensi Dinas Luar</div>
        <div class="right"></div>
    </div>
    {{-- {{dd($cekPulang->name)}} --}}
    <!-- * App Header -->
        ...
        <div class="row">
            <div class="card-body text-center pb-1">
                ...
                {{-- <input type="text" id="shift" name="shift" class="form-control" style="text-align: center"
                    disabled> --}}
                <h4> Alasan Dinas Luar</h4>
                {{-- <div id="my-ip-jq">Ip Anda:</div> --}}
                <input type="text" id="alasandinasluar" name="alasandinasluar" class="form-control"
                    style="text-align: center" placeholder="Masukkan Alasan Dinas Luar">
                <!-- Input file bukti -->
                <input type="file" id="buktidinasluar" name="buktidinasluar" class="form-control"
                    style="text-align: center" accept=".jpg,.png,.pdf">
            </div>
        </div>
    </div>
        ...
        $("#camera").click(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    image: image,
                    lokasi: lokasi,
                    alasandinasluar: $('#alasandinasluar').val(),
                    buktidinasluar: $('#buktidinasluar').prop('files')[0],
                },
                cache: false,
                success: function(respond) {
                    var status = respond.split("|");
