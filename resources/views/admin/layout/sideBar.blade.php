    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('adminDashboardadmin') }}">
                        <span
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <div class="dropend">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('obatPeriksaPegawaiIndex') }}">
                                            Obat dan Periksa
                                        </a>
                                        <a class="dropdown-item" href="{{ route('kretabPegawaiIndex') }}">
                                            Kretab
                                        </a>
                                        <a class="dropdown-item" href="{{ route('koperasiPegawaiIndex') }}">
                                            Kopkar
                                        </a>
                                        <a class="dropdown-item" href="{{ route('potonganLainPegawaiIndex') }}">
                                            Potongan Lain
                                        </a>
                                    </div>
                                </div>
